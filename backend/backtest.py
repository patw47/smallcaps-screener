...
Les harnais d'études des thèses v1/v2/v3 et le balayage de poids ont été
supprimés (Epic 7 S1) : les trois thèses ont ÉCHOUÉ leur étude pré-enregistrée
et tout re-fit est interdit. Verdicts dans docs/backtest_protocol_v2.md / _v3.md,
code dans l'historique git. Seul le backtest rapide de contrôle reste vivant.
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    run_backtest(n_tickers=args.n, forward_days=args.forward, seed=args.seed,
